<pro-header [title]="'高级表单'">
    <ng-template #breadcrumb>
        <nz-breadcrumb>
            ...
            <nz-breadcrumb-item><a [routerLink]="['/']">表单页</a></nz-breadcrumb-item>
            ...
            <div nz-col nzMd="6" nzSm="12" nzXs="24">
                <div nz-form-item nz-row>
                    ...
                    <div nz-form-control nz-col nzHasFeedback [nzValidateStatus]="name">
                        ...
                        <p nz-form-explain *ngIf="name.invalid && (name.dirty || name.touched) && name.errors.required">
                            请输入仓库名称
                        </p>
                    </div>
                </div>
            ...
            <div nz-col [nzMd]="{span:6, offset:2}" nzSm="12" nzXs="24">
                <div nz-form-item nz-row>
                    ...
                    <div nz-form-control nz-col nzHasFeedback [nzValidateStatus]="url">
                        ...
                        <p nz-form-explain *ngIf="url.invalid && (url.dirty || url.touched) && url.errors.required">
                            请输入仓库域名
                        </p>
                    </div>
                </div>
            ...
            <div nz-col [nzMd]="{span:8, offset:2}" nzSm="24" nzXs="24">
                <div nz-form-item nz-row>
                    ...
                    <div nz-form-control nz-col [nzValidateStatus]="owner">
                        ...
                        <p nz-form-explain *ngIf="owner.invalid && owner.touched && owner.errors.required">
                            请选择管理员
                        </p>
                    </div>
                </div>
            ...
            <div nz-col nzMd="6" nzSm="12" nzXs="24">
                <div nz-form-item nz-row>
                    ...
                    <div nz-form-control nz-col [nzValidateStatus]="approver">
                        ...
                        <p nz-form-explain *ngIf="approver.invalid && approver.touched && approver.errors.required">
                            请选择审批员
                        </p>
                    </div>
                </div>
                        ...
                        <div nz-col [nzSpan]="11">
                            <div nz-form-item nz-row>
                                <div nz-form-control [nzValidateStatus]="time_start">
                                    ...
                                    <p nz-form-explain *ngIf="time_start.invalid && (time_start.dirty || time_start.touched) && time_start.errors.required">
                                        请选择开始日期
                                    </p>
                                </div>
                            </div>
                        ...
                        <div nz-col [nzSpan]="11">
                            <div nz-form-item nz-row>
                                <div nz-form-control [nzValidateStatus]="time_end">
                                    ...
                                    <p nz-form-explain *ngIf="time_end.invalid && (time_end.dirty || time_end.touched) && time_end.errors.required">
                                        请选择结束日期
                                    </p>
                                </div>
                            </div>
            ...
            <div nz-col [nzMd]="{span:8, offset:2}" nzSm="24" nzXs="24">
                <div nz-form-item nz-row>
                    ...
                    <div nz-form-control nz-col [nzValidateStatus]="type">
                        ...
                        <p nz-form-explain *ngIf="type.invalid && type.touched && type.errors.required">
                            请选择仓库类型
                        </p>
                    </div>
                </div>
            ...
            <div nz-col nzMd="6" nzSm="12" nzXs="24">
                <div nz-form-item nz-row>
                    ...
                    <div nz-form-control nz-col nzHasFeedback [nzValidateStatus]="name2">
                        ...
                        <p nz-form-explain *ngIf="name2.invalid && (name2.dirty || name2.touched) && name2.errors.required">
                            请输入任务名
                        </p>
                    </div>
                </div>
            ...
            <div nz-col [nzMd]="{span:6, offset:2}" nzSm="12" nzXs="24">
                <div nz-form-item nz-row>
                    ...
                    <div nz-form-control nz-col nzHasFeedback [nzValidateStatus]="summary">
                        ...
                        <p nz-form-explain *ngIf="summary.invalid && (summary.dirty || summary.touched) && summary.errors.required">
                            请输入任务描述
                        </p>
                    </div>
                </div>
            ...
            <div nz-col [nzMd]="{span:8, offset:2}" nzSm="24" nzXs="24">
                <div nz-form-item nz-row>
                    ...
                    <div nz-form-control nz-col [nzValidateStatus]="owner2">
                        ...
                        <p nz-form-explain *ngIf="owner2.invalid && owner2.touched && owner2.errors.required">
                            请选择执行人
                        </p>
                    </div>
                </div>
            ...
            <div nz-col nzMd="6" nzSm="12" nzXs="24">
                <div nz-form-item nz-row>
                    ...
                    <div nz-form-control nz-col [nzValidateStatus]="approver2">
                        ...
                        <p nz-form-explain *ngIf="approver2.invalid && approver2.touched && approver2.errors.required">
                            请选择责任人
                        </p>
                    </div>
                </div>
            ...
            <div nz-col [nzMd]="{span:6, offset:2}" nzSm="12" nzXs="24">
                <div nz-form-item nz-row>
                    ...
                    <div nz-form-control nz-col [nzValidateStatus]="time">
                        ...
                        <p nz-form-explain *ngIf="time.invalid && time.touched && time.errors.required">
                            请选择生效时间
                        </p>
                    </div>
                </div>
            ...
            <div nz-col [nzMd]="{span:8, offset:2}" nzSm="24" nzXs="24">
                <div nz-form-item nz-row>
                    ...
                    <div nz-form-control nz-col [nzValidateStatus]="type2">
                        ...
                        <p nz-form-explain *ngIf="type2.invalid && type2.touched && type2.errors.required">
                            请选择任务类型
                        </p>
                    </div>
                </div>
