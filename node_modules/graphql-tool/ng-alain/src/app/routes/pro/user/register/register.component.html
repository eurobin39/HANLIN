...
<form nz-form [formGroup]="form" (ngSubmit)="submit()" role="form">
    ...
    <div nz-form-item>
        <div nz-form-control [nzValidateStatus]="mail">
            ...
            <div nz-form-explain *ngIf="mail.dirty&&mail.errors?.required">请输入邮箱地址！</div>
            <div nz-form-explain *ngIf="mail.dirty&&mail.errors?.email">邮箱地址格式错误！</div>
        </div>
    </div>
    <div nz-form-item>
        <div nz-form-control [nzValidateStatus]="password">
            <nz-popover [nzPlacement]="'right'" [nzTrigger]="'focus'" [(nzVisible)]="visible" nzOverlayClassName="register-password-cdk" [nzOverlayStyle]="{'width.px': 240}">
                ...
                <div nz-form-explain *ngIf="password.dirty&&password.errors?.required">请输入密码！</div>
    ...
    <div nz-form-item>
        <div nz-form-control [nzValidateStatus]="confirm">
            ...
            <div nz-form-explain *ngIf="confirm.dirty&&confirm.errors?.required">请确认密码！</div>
            <div nz-form-explain *ngIf="confirm.dirty&&confirm.errors?.equar">两次输入的密码不匹配！</div>
        </div>
    </div>
    <div nz-form-item>
        <div nz-form-control [nzValidateStatus]="mobile">
            ...
            <div nz-form-explain *ngIf="mobile.dirty&&mobile.errors?.required">请输入手机号！</div>
        </div>
    </div>
    <div nz-form-item>
        <div nz-form-control [nzValidateStatus]="captcha">
            ...
            <div nz-form-explain *ngIf="mobile.dirty&&mobile.errors?.required">请输入验证码！</div>
        </div>
    </div>
    <div nz-form-item>
