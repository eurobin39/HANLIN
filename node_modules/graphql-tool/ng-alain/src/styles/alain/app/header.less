.header {
    ...
    .logo {
        ...
        width: @aside-wd;
        transition: width .2s @layout-ease;
        a {
            display: block;
            text-align: center;
        }
...
.header-search-mixin(@enabled) when(@enabled = true) {
    ...
    .@{header-search-prefix-cls} {
        ...
        .ant-input {
            ...
            color: #fff;
            border: none;
            padding-left: @header-search-height !important;
...
.theme-icons {
    ...
    label {
        ...
        border-radius: 50%;
        text-align: center;
        width: @theme-icon-label-hw;
        height: @theme-icon-label-hw;
        margin-top: 6px;
        margin-right: 6px;
        cursor: pointer;
        position: relative;
        ...
        .anticon {
            position: absolute;
            top: (@theme-icon-label-hw - 16px) / 2;
            left: (@theme-icon-label-hw - 16px) / 2;
            font-size: 16px;
            color: #fff;
        }
    }
